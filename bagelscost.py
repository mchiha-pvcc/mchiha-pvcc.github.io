#   Name: Marah Chiha
#   Name: Marah Chiha
#   Prog Purpose: This program creates a sales receipt for Brownsville Bagles
#   Price for one bagel: $2.25
#   Price for cream cheese: $1.25
#   Sales tax rate: 6%
import datetime

############## define global vaqriables ############
...
def get_user_data():
    ...
    num_bagles= int(input("Number of bagles: "))
    num_creamch= int(input("Number of cream chees: "))
